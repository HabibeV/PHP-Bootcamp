            ...
            <div class="col-9  text-right">
              ...
              <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
                <ul class="site-menu main-menu js-clone-nav ml-auto ">
                  ...
                  <li  class="active"><a href="kayit.php" class="nav-link">Yeni Kayıt</a></li>
  ...
  <div class="card mx-4 mx-md-5 shadow-5-strong" style="
    ...
    <div class="card-body py-5 px-md-5">
      ...
      <div class="row d-flex justify-content-center">
        <div class="col-lg-8">
          <h2 class="fw-bold mb-5">Yeni Araç Ekle</h2>
          <form  method="post" action="islemler.php?islem=aracKayit" enctype=multipart/form-data>
            <!-- 2 column grid layout with text inputs for the first and last names -->
            <div class="row">
              <div class="col-md-6 mb-4">
                <div class="form-outline">
                <label class="form-label" for="form3Example1">Marka :</label>
                  <input type="text" id="form3Example1" class="form-control" name="marka" />
              ...
              <div class="col-md-6 mb-4">
                ...
                <label class="form-label" for="form3Example2"> Model :</label>
                  <input type="text" id="form3Example2" class="form-control" name="model" />
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6 mb-4">
                ...
                <label class="form-label" for="form3Example1">Yıl :</label>
                  <input type="text" id="form3Example1" class="form-control" name="yil" />
                  
                </div>
              </div>
              <div class="col-md-6 mb-4">
                <div class="form-outline">
                <label class="form-label" for="form3Example2"> Plaka :</label>
                  <input type="text" id="form3Example2" class="form-control" name="plaka" />
                </div>
              </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="form-outline">
                <label class="form-label" for="form3Example2"> Resim :</label> 
